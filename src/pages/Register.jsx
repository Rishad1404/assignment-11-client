...
const Register = () => {
    ...
    const { createUser,googleLogin,updateUserProfile,user,setUser } = useContext(AuthContext)
            ...
            <div className='flex justify-center items-center min-h-[calc(100vh-306px)] my-5'>
                <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-base-200 rounded-lg shadow-lg  lg:max-w-4xl '>
                    <div className='w-full px-6 py-8 md:px-8 lg:w-1/2'>
                        ...
                        <div onClick={handleGoogleLogin} className='flex cursor-pointer items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg bg-base-100   hover:bg-gray-50 '>
